...
var ASM_CONSTS = {
  12341914: () => { if (document.fullscreenElement) return 1; },  
 12341960: () => { return Module.canvas.width; },  
 12341992: () => { return parseInt(Module.canvas.style.width); },  
 12342040: () => { document.exitFullscreen(); },  
 12342067: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 12342139: () => { if (document.fullscreenElement) return 1; },  
 12342185: () => { return Module.canvas.width; },  
 12342217: () => { return screen.width; },  
 12342242: () => { document.exitFullscreen(); },  
 12342269: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 12342463: () => { return window.innerWidth; },  
 12342489: () => { return window.innerHeight; },  
 12342516: () => { if (document.fullscreenElement) return 1; },  
 12342562: () => { return Module.canvas.width; },  
 12342594: () => { return parseInt(Module.canvas.style.width); },  
 12342642: () => { if (document.fullscreenElement) return 1; },  
 12342688: () => { return Module.canvas.width; },  
 12342720: () => { return screen.width; },  
 12342745: () => { return window.innerWidth; },  
 12342771: () => { return window.innerHeight; },  
 12342798: () => { if (document.fullscreenElement) return 1; },  
 12342844: () => { return Module.canvas.width; },  
 12342876: () => { return screen.width; },  
 12342901: () => { document.exitFullscreen(); },  
 12342928: () => { if (document.fullscreenElement) return 1; },  
 12342974: () => { return Module.canvas.width; },  
 12343006: () => { return parseInt(Module.canvas.style.width); },  
 12343054: () => { document.exitFullscreen(); },  
 12343081: ($0) => { Module.canvas.style.opacity = $0; },  
 12343119: () => { return screen.width; },  
 12343144: () => { return screen.height; },  
 12343170: () => { return window.screenX; },  
 12343197: () => { return window.screenY; },  
 12343224: () => { return window.devicePixelRatio; },  
 12343260: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 12343313: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 12343364: () => { Module.canvas.style.cursor = 'none'; },  
 12343401: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 12343657: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 12343708: () => { if (document.pointerLockElement) return 1; },  
 12343755: () => { if (document.fullscreenElement) return 1; },  
 12343801: () => { return window.innerWidth; },  
 12343827: () => { return window.innerHeight; }
};
