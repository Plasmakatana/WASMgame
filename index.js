...
var ASM_CONSTS = {
  12341898: () => { if (document.fullscreenElement) return 1; },  
 12341944: () => { return Module.canvas.width; },  
 12341976: () => { return parseInt(Module.canvas.style.width); },  
 12342024: () => { document.exitFullscreen(); },  
 12342051: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 12342123: () => { if (document.fullscreenElement) return 1; },  
 12342169: () => { return Module.canvas.width; },  
 12342201: () => { return screen.width; },  
 12342226: () => { document.exitFullscreen(); },  
 12342253: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 12342447: () => { return window.innerWidth; },  
 12342473: () => { return window.innerHeight; },  
 12342500: () => { if (document.fullscreenElement) return 1; },  
 12342546: () => { return Module.canvas.width; },  
 12342578: () => { return parseInt(Module.canvas.style.width); },  
 12342626: () => { if (document.fullscreenElement) return 1; },  
 12342672: () => { return Module.canvas.width; },  
 12342704: () => { return screen.width; },  
 12342729: () => { return window.innerWidth; },  
 12342755: () => { return window.innerHeight; },  
 12342782: () => { if (document.fullscreenElement) return 1; },  
 12342828: () => { return Module.canvas.width; },  
 12342860: () => { return screen.width; },  
 12342885: () => { document.exitFullscreen(); },  
 12342912: () => { if (document.fullscreenElement) return 1; },  
 12342958: () => { return Module.canvas.width; },  
 12342990: () => { return parseInt(Module.canvas.style.width); },  
 12343038: () => { document.exitFullscreen(); },  
 12343065: ($0) => { Module.canvas.style.opacity = $0; },  
 12343103: () => { return screen.width; },  
 12343128: () => { return screen.height; },  
 12343154: () => { return window.screenX; },  
 12343181: () => { return window.screenY; },  
 12343208: () => { return window.devicePixelRatio; },  
 12343244: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 12343297: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 12343348: () => { Module.canvas.style.cursor = 'none'; },  
 12343385: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 12343641: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 12343692: () => { if (document.pointerLockElement) return 1; },  
 12343739: () => { if (document.fullscreenElement) return 1; },  
 12343785: () => { return window.innerWidth; },  
 12343811: () => { return window.innerHeight; }
};
